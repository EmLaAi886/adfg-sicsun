...
app.get('/predict', async (req, res) => {
    ...
    res.json({
        ...
        phien_hien_tai: parseInt(nextPhien),
        du_doan: lastPrediction.du_doan,
        dudoan_vi: lastPrediction.doan_vi, // Changed from .join() to the raw array
        do_tin_cay: parseFloat(lastPrediction.do_tin_cay), // Changed from string to a float
